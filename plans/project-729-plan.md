# Project 729 — Implementation Plan
...
- Shows: `"Install Project 729 as an app"` with `INSTALL` + `DISMISS` buttons
...
interface AppSettings {
  ...
  installBannerDismissed: boolean;   // ← new: hides PWA install prompt
  theme: 'dark-terminal';
}
```
...
**Layout**:
- Top bar: `PROJECT 729 // DAY [X] OF 1,127` + thin green progress bar
