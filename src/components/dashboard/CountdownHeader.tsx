...
export default function CountdownHeader({ dayNumber, daysRemaining, progress, totalDays }: Props) {
  return (
    <div className="sticky top-0 z-50 bg-black border-b border-border">
      ...
      <div className="h-0.5 bg-border">
        <div
          ...
          style={{ width: `${Math.min(progress, 100)}%`, boxShadow: '0 0 6px var(--accent)' }}
        />
      </div>
